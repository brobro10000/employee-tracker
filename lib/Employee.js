...
let test1 = new Role(9,test0.getName(),'Head Engineer',50000, test0.getDepartmentId())
let test2 = new Employee(3,test1.getName(),test1.getTitle(),test1.getSalary(),test1.getDepartmentId(),'James','Monroe',test1.getRoleId())
arr.push(test0)
arr.push(test1)
arr.push(test2)
